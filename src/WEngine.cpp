...
void WEngine::SetWindowSize(const uint32_t _width, const uint32_t _height)
{
    width = _width;
    height = _height;
}
...
void WEngine::record_command_buffer(const uint32_t imageIndex) const
{
...
void WEngine::transition_image_layout(const uint32_t imageIndex, const vk::ImageLayout oldLayout, const vk::ImageLayout newLayout, const vk::AccessFlags2 srcAccessMask, const vk::AccessFlags2 dstAccessMask, const vk::PipelineStageFlags2 srcStageMask, const vk::PipelineStageFlags2 dstStageMask) const
{
...
void WEngine::frame_buffer_resize_callback(GLFWwindow* window, int width, int height)
{
...
void WEngine::create_vertex_buffer()
{
    ...
    void* data = vertex_buffer_memory.mapMemory(0, bufferCI.size);
...
vk::Bool32 WEngine::debugCallback(const vk::DebugUtilsMessageSeverityFlagBitsEXT severity, const vk::DebugUtilsMessageTypeFlagsEXT type, const vk::DebugUtilsMessengerCallbackDataEXT *pCallbackData, void *)
{
